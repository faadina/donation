    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <div class="search-box">
                ...
                <button class="btn btn-primary" type="button" onclick="searchDonor()" style="background-color: #454B1B; border:none;">
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo "<td class='table-actions'><a href='DonorUpdate.php?donorID=" . $row["donorID"] . "' class='btn btn-primary'style='background-color: #454B1B; border:none;' ><i class='bi bi-pencil'></i></a></td>";
                        echo "</tr>";
                        $count++;
                    }
                } else {
            ...
            <ul class="pagination justify-content-center">
                <?php for ($i = 1; $i <= $total_pages; $i++) : ?>
                    <li class="page-item <?php if ($i == $page) echo 'active'; ?>">
                        <a class="page-link <?php if ($i == $page) echo 'active-link'; ?>" href="DonorView.php?page=<?php echo $i; ?>"><?php echo $i; ?></a>
                    </li>
                <?php endfor; ?>
            </ul>
        </nav>
